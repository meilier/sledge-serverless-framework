...
run_samples() {
	...
	hey -n "$perf_window_buffer_size" -c "$perf_window_buffer_size" -q 200 -cpus 3 -o csv -m GET "http://${hostname}:10000"  || {
		printf "[ERR]\n"
...
#experiment_client 47.96.189.226 /root/github/sledge-serverless-framework/runtime/experiments/concurrency/res
generate_gnuplots /root/github/sledge-serverless-framework/runtime/experiments/concurrency/res "$__run_sh__base_path"
